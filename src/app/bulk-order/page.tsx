    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-[#1a1a1a] dark:text-white mb-3 md:mb-6">
              Bulk Orders & Contact
            </h1>
            <p className="text-gray-600 dark:text-gray-300 text-lg mb-3 md:mb-6 md:mb-12">
