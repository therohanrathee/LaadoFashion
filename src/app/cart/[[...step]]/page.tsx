  ...
  return (
    <>
      ...
      {!promoData ? (
        ...
        <div className="flex items-center justify-between bg-green-50/50 dark:bg-green-900/10 border border-green-200 dark:border-green-800/30 px-4 py-3 rounded-lg mb-2">
          <div className="flex flex-col">
            <span className="text-sm font-bold text-green-700 dark:text-green-500 uppercase">{promoData.code}</span>
            <span className="text-xs text-green-600 dark:text-green-400">Code Applied Successfully</span>
          </div>
          <button 
      ...
      {promoError && !promoData && <p className="text-xs text-red-500 mb-4">{promoError}</p>}
      ...
      <div className="space-y-4 text-sm text-gray-600 dark:text-gray-300 mb-6">
        ...
        <div className="flex justify-between items-center">
          ...
          {isFreeEligible || deliveryCharge === 0 ? (
            <div className="flex items-center gap-2">
        ...
        {customDiscount > 0 && (
          <div className="flex justify-between items-center">
            <span className="text-[#E91E63] font-semibold">Promo Discount</span>
            <span className="font-bold text-[#E91E63]">-₹{customDiscount}</span>
          </div>
        )}
      </div>
