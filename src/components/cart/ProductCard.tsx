...
export default function ProductCard({ item }: ProductCardProps) {
  ...
  return (
    <div className="w-full h-full group relative isolation-isolate translate-z-0">
      <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-sm transition-shadow duration-300 group-hover:shadow-2xl bg-white/70 dark:bg-[#141414]/70 backdrop-blur-sm border border-gray-100 dark:border-white/5 flex flex-col translate-z-0">
        {/* Image Container */}
