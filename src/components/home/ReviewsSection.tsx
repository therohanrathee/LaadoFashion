  ...
  return (
    <section className="relative py-24 bg-[#FAF8F5] dark:bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute bottom-[10%] right-[10%] w-[50%] h-[50%] rounded-full bg-[#C5A55A]/[0.08] blur-[120px]" />
      </div>
      ...
      <div className="relative z-20 w-full flex overflow-hidden py-4">
        ...
        >
          {SCROLLING_REVIEWS.map((review, index) => (
            <div 
              key={index} 
              className="w-80 md:w-96 shrink-0 bg-white/40 dark:bg-white/5 backdrop-blur-sm border border-white/40 dark:border-white/5 rounded-2xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.06)] flex flex-col"
            >
