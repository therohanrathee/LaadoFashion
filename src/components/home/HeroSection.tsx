...
export default function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden bg-[#FAF8F5] pt-[80px] min-h-[calc(100vh-80px)] flex items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full py-10 lg:py-12">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="text-left">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="flex flex-wrap gap-3 mb-6 lg:mb-8">
            ...
            >
              <SplitBookButton 
                ...
                className="bg-[#E91E63] text-white font-bold text-sm uppercase tracking-wider px-8 py-4 rounded-lg shadow-sm hover:bg-[#C2185B] transition-colors whitespace-nowrap"
