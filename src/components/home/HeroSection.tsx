      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full py-12 lg:py-16">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="text-left">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="inline-flex items-center gap-2 bg-[#E91E63]/5 border border-[#E91E63]/10 rounded-full px-5 py-2 mb-6 lg:mb-8">
            ...
            <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.4 }} className="text-6xl sm:text-7xl font-serif font-bold leading-[1.08] mb-6 lg:mb-8 text-[#1a1a1a]">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="flex flex-wrap gap-4 mb-6 lg:mb-8">
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.7 }} className="text-lg lg:text-xl text-gray-600 font-light max-w-lg mb-8 lg:mb-10 leading-relaxed">
            ...
            {/* Stats */}
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 1.2 }} className="mt-12 lg:mt-16 flex gap-10">
              {[ { number: '650+', label: 'Happy Clients' }, { number: '4.9★', label: 'Google Rating' } ].map((stat, i) => (
                <div key={i}>
                  <div className="text-3xl lg:text-4xl font-serif font-bold text-[#1a1a1a]">{stat.number}</div>
          ...
          <motion.div 
            ...
            className="relative hidden lg:block aspect-[4/3] xl:aspect-[5/4] w-full max-w-[600px] xl:max-w-[700px] lg:ml-auto rounded-2xl overflow-hidden shadow-2xl"
          >
            <Image 
