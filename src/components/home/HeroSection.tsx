        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="text-left w-full mt-4 lg:mt-0 max-w-xl lg:max-w-none">
            ...
            <motion.div
              ...
              className="relative flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto mt-2"
            >
              <SplitBookButton 
                defaultText="Book a Measurement"
                className="bg-[#E91E63] text-white font-bold text-sm uppercase tracking-wider px-6 lg:px-8 py-4 rounded-lg shadow-sm hover:bg-[#C2185B] transition-colors whitespace-nowrap w-full sm:w-auto text-center"
                splitClassName="px-6 py-4 text-sm"
              />
              <a 
                href="tel:+919716299990" 
                className="flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-sm uppercase tracking-wider px-6 lg:px-8 py-4 rounded-lg shadow-sm hover:bg-[#20bd5a] transition-colors whitespace-nowrap w-full sm:w-auto"
              >
